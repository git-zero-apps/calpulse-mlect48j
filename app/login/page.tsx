    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-brand-600 to-brand-800 items-center justify-center p-12">
        <div className="max-w-md">
          <h1 className="text-4xl font-bold text-white mb-4">CalPulse</h1>
          <p className="text-brand-100 text-lg leading-relaxed">Stop the email tennis. Share your link, get booked.</p>
        </div>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center p-8">
        <div className="w-full max-w-sm">
          <Link href="/" className="text-2xl font-bold text-gray-900 lg:hidden block mb-8">CalPulse</Link>
          <h2 className="text-2xl font-bold text-gray-900 mb-2">
            {mode === "login" ? "Welcome back" : "Create your account"}
          </h2>
          <p className="text-gray-500 mb-8">
            {mode === "login" ? "Sign in to your account to continue." : "Get started with CalPulse today."}
          </p>
